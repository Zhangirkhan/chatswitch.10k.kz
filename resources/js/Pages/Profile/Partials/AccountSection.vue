    ...
    <div class="h-full flex flex-col">
        ...
        <div class="flex-1 overflow-y-auto wa-scrollbar py-2">
            ...
            <details class="info-details group">
                <summary class="list-none cursor-pointer">
                    <div class="account-item">
                        ...
                        <span class="text-[15px] text-[var(--wa-text)]">Уведомления безопасности</span>
                    </div>
                </summary>
                <div class="px-16 pb-4 text-xs text-[var(--wa-text-secondary)] leading-relaxed">
                    Получайте уведомления, когда код безопасности меняется у вашего собеседника.
            ...
            <details class="info-details">
                <summary class="list-none cursor-pointer">
                    <div class="account-item">
                        ...
                        <span class="text-[15px] text-[var(--wa-text)]">Запросить информацию аккаунта</span>
                    </div>
                </summary>
                <div class="px-16 pb-4 text-xs text-[var(--wa-text-secondary)] leading-relaxed">
                    Запросите копию информации своего аккаунта. Отчёт будет доступен администратору.
                </div>
            </details>
            ...
            <button type="button" class="account-item w-full" @click="showPasswordForm = !showPasswordForm">
                ...
                <span class="text-[15px] text-[var(--wa-text)] flex-1 text-left">Изменить пароль</span>
            ...
            <form v-if="showPasswordForm" @submit.prevent="savePassword" class="px-6 py-4 space-y-4 bg-[var(--wa-panel-hover)]">
                <div>
                    <label class="block text-xs text-[var(--wa-accent)] mb-1">Текущий пароль</label>
                    <input
                ...
                <div>
                    <label class="block text-xs text-[var(--wa-accent)] mb-1">Новый пароль</label>
                    <input
                ...
                <div>
                    <label class="block text-xs text-[var(--wa-accent)] mb-1">Повторите пароль</label>
                    <input
                ...
                <div class="flex items-center gap-3">
                    ...
                    <span v-if="passwordForm.recentlySuccessful" class="text-xs" :style="{ color: 'var(--wa-accent)' }">Сохранено</span>
                </div>
            </form>
            ...
            <button type="button" class="account-item w-full" @click="showDeleteForm = !showDeleteForm">
                ...
                <span class="text-[15px] text-[var(--wa-text)] flex-1 text-left">Как удалить свой аккаунт</span>
            ...
            <div v-if="showDeleteForm" class="px-6 py-4 bg-[var(--wa-panel-hover)] space-y-3">
                <p class="text-xs text-[var(--wa-text-secondary)] leading-relaxed">
                    После удаления аккаунта все ваши чаты и назначения будут удалены безвозвратно.
