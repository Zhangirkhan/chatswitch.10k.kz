    ...
    'structured' => [
        'faq' => [
            'kk' => [
                ...
                ['question' => 'Қораптык орнату деген не?', 'answer' => 'Бұл платформаны 1 000 000 ₸ бір рет төлеп орнату. Қолдау, жаңартулар және сопровождение — айына 40 000 ₸. AI токендері бөлек.'],
            ...
            'ru' => [
                ...
                ['question' => 'Что такое коробочная установка?', 'answer' => 'Разовая установка платформы за 1 000 000 ₸. Поддержка, обновления и сопровождение — 40 000 ₸ в месяц. AI-токены оплачиваются отдельно.'],
            ...
            'en' => [
                ...
                ['question' => 'What is boxed installation?', 'answer' => 'A one-time 1,000,000 ₸ platform setup. Support, updates and maintenance — 40,000 ₸ per month. AI tokens are billed separately.'],
