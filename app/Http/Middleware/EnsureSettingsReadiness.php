...
/**
 * Для администратора: не пускать в «продвинутые» AI-разделы, пока готовность не достигнута.
 * Воронки и база знаний доступны без gate — это шаги онбординга для восстановления readiness.
 */
