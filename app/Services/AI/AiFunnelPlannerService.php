...
PROMPT;
    ...
    private function paymentBypassPromptRule(): string
    {
        ...
        return <<<'RULE'
32. Интеграции оплаты нет. Не спрашивай реквизиты, предоплату, ссылку на оплату. После согласования условий переводи сразу в производство/работу, пропуская payment-этапы воронки.
RULE;
    }
}
