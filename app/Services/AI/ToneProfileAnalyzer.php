...
final class ToneProfileAnalyzer
{
    ...
    {
        $prompt = "Проанализируй стиль сотрудника по всем примерам сообщений ниже. Верни JSON с полями summary (строка) и phrases (массив до 12 коротких типичных формулировок). Не включай персональные данные.\n\nПримеры:\n- ".implode("\n- ", $samples);
