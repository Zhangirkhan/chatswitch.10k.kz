...
Верни строго JSON-объект со следующими полями:
{
  ...
  "timeline":         "когда нужно, срок покупки или выполнения: конкретная дата, неделя, «срочно», «смотрю на будущее» и т.п.",
  "decision_maker":   "кто принимает решение о покупке: сам клиент, супруг, директор, «нужно согласовать» и т.п.",
  "reason_for_contact": "почему клиент обратился: проблема, задача, повод — чего он хочет добиться",
...
- timeline: если клиент сказал «срочно» / «нужно на следующей неделе» / «смотрю пока» — зафиксируй дословно.
- decision_maker: если клиент сказал «спрошу мужа/директора», «нужно согласовать», «решаю сам» — зафиксируй.
PROMPT;
